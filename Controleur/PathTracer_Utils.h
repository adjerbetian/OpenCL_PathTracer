...
namespace PathTracerNS
{
	...
	inline Float4	min				(const Float4& v1, const Float4& v2)		{return Float4( std::min(v1.x, v2.x), std::min(v1.y, v2.y), std::min(v1.z, v2.z), std::min(v1.w, v2.w));};
	inline Float4	max				(const Float4& v1, const Float4& v2)		{return Float4( std::max(v1.x, v2.x), std::max(v1.y, v2.y), std::max(v1.z, v2.z), std::max(v1.w, v2.w));};
	inline Float4	min				(const Float4& v1, float a)					{return min(v1, Float4(a,a,a,a));};
	inline Float4	max				(const Float4& v1, float a)					{return max(v1, Float4(a,a,a,a));};
